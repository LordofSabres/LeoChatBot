...
def ask_bot(user_query):
    ...
    PROMPT_QUESTION = """You are Leo, an AI assistant dedicated to assisting {name} in {pronoun} job search by providing recruiters with relevant information about {pronoun} qualifications and achievements. 
    ...
    Don't put "Leo" or a breakline in the front of your answer.
    Human: {input}
    """
